create database if not exists QuanLyKhuNghiDuong;
...
insert into nhan_vien(ho_ten,ngay_sinh,so_smnd,luong,so_dem_thoai,email,dai_chi,ma_vi_tri,ma_trinh_do,ma_bo_phan)
values ('Nguyễn Văn An','1970-11-07','456231786',10000000,'0901234121','annguyen@gmail.com','295 Nguyễn Tất Thành, Đà Nẵng',1,3,1),
        ...
        ('Hồ Thị Yến','1995-12-12','999231723',14000000,'0412352315','thiyen@gmail.com','29315 Nguyễn Tất Thành, Đà Nẵng',1,3,2),
        ('Võ Công Toản','1980-04-04','123231365',17000000,'0374443232','toan0404@gmail.com','29125 Nguyễn Tất Thành, Đà Nẵng',1,4,4),
        ('Nguyễn Bỉnh Phát','1999-12-09','454363232',6000000,'0902341231','phatphat@gmail.com','K234/11 Điện Biên Phủ, Gia Lai',2,1,1),
        ('Khúc Nguyễn An Nghi','2000-11-08','964542311',7000000,'0978653213','annghi20@gmail.com','2956 Nguyễn Tất Thành, Đà Nẵng',2,2,3),
        ('Nguyễn Hữu Hà','1993-01-01','534323231',8000000,'0941234523','nhh0101@gmail.com','4 Nguyễn Chí Thanh, Huế',2,3,2),
        ('Nguyễn Hà Đông','1989-09-03','234414123',7000000,'0941234553','donghanguyen@gmail.com','2915 Nguyễn Tất Thành, Đà Nẵng',2,4,4),
        ('Tòng Hoang','1982-09-03','256781231',8000000,'0245144444','hoangtong@gmail.com','213 Hàm Nghi, Đà Nẵng',2,4,4),
        ('Nguyễn Công Đạo','1994-01-08','755434343',10000000,'0988767111','nguyencongdao12@gmail.com','2 Nguyễn Tất Thành, Đà Nẵng',2,3,2);
insert into loai_khach(ten_loai_khach) values ('Diamond'),('Platinium'),('Gold'),('Silver'),('Member');
insert into khach_hang(ma_loai_khach, ho_ten, ngay_sinh, gioi_tinh, so_smnd, so_dien_thoai, email, dia_chi)
values (5,'Nguyễn Thị Hào','1970-11-07',0,'643431213','0945423362','thihao07@gmail.com','23 Nguyễn Hoàng, Đà Nẵng'),
        ...
        (1,'Dương Văn Quan','1981-07-08',1,'543432111','0373213122','duongquan@gmail.com','K453/12 Lê Lợi, Đà Nẵng'),
        (4,'Hoàng Trần Nhi Nhi','1995-12-09',1,'795453345','0490039241','nhinhi123@gmail.com','224 Lý Thái Tổ, Gia Lai'),
        (4,'Tôn Nữ Mộc Châu','2005-12-06',0,'732434215','0312345678','tonnuchau@gmail.com','37 Yên Thế, Đà Nẵng'),
        (1,'Nguyễn Mỹ Kim','1984-04-08',0,'856453123','0988888844','kimcuong84@gmail.com','K123/45 Lê Lợi, Hồ Chí Minh'),
        (3,'Nguyễn Thị Quỳnh','1994-07-01',0,'965656433','0912345698','haohao99@gmail.com','55 Nguyễn Văn Linh, Kon Tum'),
        (1,'Trần Đại Danh','1989-07-01',1,'432341235','0763212345','danhhai99@gmail.com','24 Lý Thường Kiệt, Quảng Ngãig'),
        (2,'Nguyễn Tâm Đắc','1979-11-07',1,'344343432','0987654321','dactam@gmail.com','22 Ngô Quyền, Đà Nẵng');
...
values ('Villa Beach Front',25000, 10000000,10,3,1,'vip','Có hồ bơi', 500, 4),
		('House Princess 01',140000, 5000000,7,2,2,'vip','Có thêm bếp nướng', null, 3),
...
insert into dich_vu_di_kem(ten_dich_di_kem,gia,don_vi,trang_thai)
...
select * from nhan_vien
where ho_ten regexp '^[HKT]' and CHAR_LENGTH(ho_ten)<16;

-- 3.Hiển thị thông tin của tất cả khách hàng có độ tuổi từ 18 đến 50 tuổi và
-- có địa chỉ ở “Đà Nẵng” hoặc “Quảng Trị”.
select * from khach_hang;
select * from khach_hang 
where TIMESTAMPDIFF (year,ngay_sinh,now())
between 18 and 50 and dia_chi regexp '(Quảng Trị|Đà Nẵng)'
order by ngay_sinh;
...
-- “Diamond”.
select c.ma_khach_hang, c.ho_ten, t.ten_loai_khach, count(c.ma_khach_hang) as so_lan_dat 
from khach_hang c 
...
select c.ma_khach_hang, c.ho_ten, t.ten_loai_khach, hd.ma_hop_dong, dv.ten_dich_vu,
hd.ngay_lam_hop_dong,hd.ngay_ket_thuc,ifnull (ifnull (dv.chi_phi_thue,0) + ifnull (sum(dvdk.gia*hdct.so_luong),0),0) as tong_tien
from khach_hang c 
left join loai_khach t on c.ma_loai_khach=t.ma_loai_khach
left join hop_dong hd on c.ma_khach_hang=hd.ma_khach_hang
...
select month(ngay_lam_hop_dong) as thang, count(ma_khach_hang) as sl_khach_hang
from hop_dong hd
...
ifnull(sum(hdct.so_luong),0) as sl_dich_vu_di_kem from hop_dong hd
left join hop_dong_chi_tiet hdct on hd.ma_hop_dong=hdct.ma_hop_dong
...
select dvdk.ma_dich_vu_di_kem,dvdk.ten_dich_di_kem from dich_vu_di_kem dvdk
...
select hd.ma_hop_dong,nv.ho_ten,kh.ho_ten,kh.so_dien_thoai,dv.ten_dich_vu,ifnull (sum(hdct.ma_dich_vu_di_kem),0) as so_luong,
hd.tien_dat_coc from hop_dong hd
left join nhan_vien nv on nv.ma_nhan_vien = hd.ma_nhan_vien
left join khach_hang kh on kh.ma_khach_hang = hd.ma_khach_hang
left join dich_vu dv on dv.ma_dich_vu=hd.ma_dich_vu
left join hop_dong_chi_tiet hdct on hdct.ma_hop_dong=hd.ma_hop_dong
where hd.ma_hop_dong in 
(select ma_hop_dong from hop_dong where ngay_lam_hop_dong between'2020-10-01'and '2020-12-31' )
...
select sum(hdct.so_luong) so_lan_su_dung, dvdk.ten_dich_di_kem,dvdk.ma_dich_vu_di_kem
from dich_vu_di_kem dvdk
join hop_dong_chi_tiet hdct on hdct.ma_dich_vu_di_kem = dvdk.ma_dich_vu_di_kem
group by dvdk.ma_dich_vu_di_kem;

select ten_dich_di_kem, so_lan_su_dung,ma_dich_vu_di_kem 
...
select hd.ma_hop_dong,ldv.ten_loai_dich_vu,dvdk.ten_dich_di_kem,count(dvdk.ma_dich_vu_di_kem) as so_lan_su_dung
from hop_dong hd
...
select nv.ma_nhan_vien,nv.ho_ten,td.ten_trinh_do,bp.ten_bo_phan,nv.so_dem_thoai,nv.dai_chi
from nhan_vien nv 
join trinh_do td on td.ma_trinh_do = nv.ma_trinh_do
join bo_phan bp on bp.ma_bo_phan= nv.ma_bo_phan
join hop_dong hd on hd.ma_nhan_vien= nv.ma_nhan_vien
where hd.ma_hop_dong in 
(select ma_hop_dong from hop_dong where ngay_lam_hop_dong between '2020-01-01' and '2021-12-31' )
...
delete from nhan_vien nv where not exists
 (select * from hop_dong where ma_nhan_vien= nv.ma_nhan_vien
...
select ma_nhan_vien as id,ho_ten,email,so_dem_thoai,ngay_sinh,dai_chi from nhan_vien
union All
